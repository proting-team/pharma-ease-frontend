<template>
  <div
    class="min-h-screen flex items-center justify-center bg-gradient-to-br from-emerald-50 via-white to-emerald-50 px-4 py-8"
  >
    <div
      class="w-full max-w-md bg-white py-8 px-4 shadow-xl shadow-black/5 border border-gray-200 sm:rounded-xl sm:px-10 relative overflow-hidden"
    >
      <div class="sm:mx-auto sm:w-full sm:max-w-md text-center mb-8">
        ...
        <p class="mt-2 text-sm text-gray-500">Welcome back! Please login to your account</p>
      </div>
        ...
        <div class="flex items-center justify-between">
          ...
          <div class="text-sm">
            <a
              ...
              class="font-medium text-emerald-600 hover:text-emerald-800 transition-colors"
            >
              Forgot Password?
            </a>
          </div>
