<template>
  <div class="p-8 bg-gray-50 min-h-screen font-sans">
    ...
    <div
      v-if="error"
      class="mb-4 p-4 bg-red-50 border border-red-200 rounded-md text-red-600 text-sm"
    >
      {{ error }}
    </div>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200">
      ...
      >
        ...
        <div class="flex items-center gap-3">
          ...
          <button
            class="p-2 border border-gray-300 rounded-md text-gray-600 hover:bg-gray-50 transition-colors"
          >
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path
                stroke-linecap="round"
        ...
        <table class="w-full text-left border-collapse">
          <thead>
            <tr class="border-b border-gray-200 bg-gray-50/50">
              ...
              <th class="px-6 py-4 text-xs font-semibold text-gray-500 uppercase text-right">
                Actions
              </th>
            </tr>
          </thead>
          <tbody class="divide-y divide-gray-100">
            ...
            >
              ...
              <td class="px-6 py-4 text-sm">
                <span
                  :class="getStockBadgeClass(item.stock || 0)"
                  class="inline-flex items-center justify-center px-3 py-1 rounded-full text-xs font-medium whitespace-nowrap"
                >
      ...
      <div class="px-6 py-4 border-t border-gray-200 flex items-center justify-between">
        ...
        <div class="flex gap-2">
          <button
            ...
            class="px-3 py-1 border rounded text-sm disabled:opacity-50 hover:bg-gray-50 transition-colors"
          >
            Prev
          </button>
          <button
    ...
    <AddMedicineModal
      :is-open="isModalOpen"
      :medicine-to-edit="selectedMedicine"
      @close="closeModal"
