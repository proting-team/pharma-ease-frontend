...
const isUserManagementActive = computed(
  () => route.path === '/supplier' || route.path === '/user-management',
)
  ...
  <div v-else class="flex h-screen bg-white font-sans text-gray-800">
    <aside class="w-64 bg-[#11764B] text-white flex flex-col">
      ...
      <nav class="flex-1 px-4 pt-4 space-y-2">
        <RouterLink
          to="/"
          class="flex items-center px-4 py-3 rounded-lg hover:bg-[#1a8a5b] transition-colors"
        ...
        <RouterLink
          v-if="['ADMIN', 'OWNER', 'PHARMACIST'].includes(authStore.userRole ?? '')"
          to="/medicines"
          class="flex items-center px-4 py-3 rounded-lg hover:bg-[#1a8a5b] transition-colors"
          exact-active-class="bg-[#21a870] font-semibold"
        >
        ...
        <RouterLink
          v-if="['ADMIN', 'OWNER', 'CASHIER'].includes(authStore.userRole ?? '')"
          to="/cashier"
          class="flex items-center px-4 py-3 rounded-lg hover:bg-[#1a8a5b] transition-colors"
          exact-active-class="bg-[#21a870] font-semibold"
        >
        ...
        <div v-if="['ADMIN', 'OWNER', 'PHARMACIST'].includes(authStore.userRole ?? '')">
          ...
          <transition name="dropdown">
            <div
              ...
              class="ml-4 mt-1 space-y-1 border-l border-green-600/30 pl-3"
            >
              <RouterLink
                v-if="['OWNER', 'PHARMACIST'].includes(authStore.userRole ?? '')"
                to="/supplier"
              ...
              <RouterLink
                v-if="['ADMIN', 'OWNER'].includes(authStore.userRole ?? '')"
                to="/user-management"
                class="flex items-center px-3 py-2 text-sm rounded-lg hover:bg-[#1a8a5b] transition-colors"
                exact-active-class="bg-[#21a870] font-semibold"
              >
    ...
    <div class="flex-1 flex flex-col overflow-hidden">
      <header
        class="h-16 bg-white border-b border-gray-100 flex items-center justify-end px-8 shadow-sm"
      >
        <div class="flex items-center gap-6">
          ...
          <div class="flex items-center gap-3">
            <div
              class="w-10 h-10 rounded-full bg-[#11764B] text-white flex items-center justify-center font-bold"
            >
