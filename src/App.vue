  ...
  <div class="flex h-screen bg-white font-sans text-gray-800">
    ...
    <aside class="w-64 bg-[#11764B] text-white flex flex-col">
      ...
      <nav class="flex-1 px-4 space-y-2">
        ...
        <RouterLink to="/supplier" class="block px-4 py-3 rounded-lg hover:bg-[#1a8a5b] transition-colors"
          exact-active-class="bg-[#21a870] font-semibold">
          Suppliers
        </RouterLink>

        <RouterLink to="/user-management" class="block px-4 py-3 rounded-lg hover:bg-[#1a8a5b] transition-colors"
          exact-active-class="bg-[#21a870] font-semibold">
          User Management
        </RouterLink>
      </nav>
